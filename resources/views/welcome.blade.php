...
@section('content')
<div class="container-fluid mx-auto max-w-full overflow-x-hidden">
<!-- Hero Slider -->
    ...
    <div class="relative z-10 h-full flex items-center">
      <div class="container mx-auto px-4 sm:px-6">
        <div class="max-w-4xl animate-slide-in-left">
          ...
          <p class="text-base sm:text-xl md:text-2xl mb-6 sm:mb-8 text-gray-200 font-light">
            Former les champions de demain, sur le terrain et dans la vie
          </p>
          <div class="flex flex-wrap gap-3 sm:gap-4">
            <button class="px-5 py-3 sm:px-8 sm:py-4 bg-primary rounded-full font-bold text-base sm:text-lg hover:bg-primary/90 transition-all glow-button">
              Rejoignez-nous
            </button>
            <button class="px-5 py-3 sm:px-8 sm:py-4 bg-white/10 backdrop-blur-sm rounded-full font-bold text-base sm:text-lg hover:bg-white/20 transition-all border-2 border-white/30">
              En savoir plus
            </button>
          </div>
        </div>
...
<!-- About Section -->
<section id="apropos" class="py-16 sm:py-20 md:py-24 bg-slate-900">
  <div class="container mx-auto px-4 sm:px-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
      <div class="relative reveal-left order-2 md:order-1">
        <div class="absolute -top-10 -left-10 w-48 h-48 sm:w-72 sm:h-72 bg-primary/20 rounded-full blur-3xl"></div>
      ...
      <div class="reveal-right order-1 md:order-2">
        <h3 class="text-primary font-bold mb-3 sm:mb-4 text-xs sm:text-sm uppercase tracking-wider">Le mot du fondateur</h3>
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6">Charles Kaboré</h2>
        <p class="text-lg sm:text-xl text-gray-400 mb-3 sm:mb-4 font-light">Ancien Capitaine des Étalons du Burkina Faso</p>
        ...
        <button class="px-6 py-3 sm:px-8 sm:py-4 bg-primary rounded-full font-bold text-sm sm:text-base hover:bg-primary/90 transition-all glow-button">
          Notre histoire
        </button>
      </div>
    </div>
...
<!-- Programs Section -->
<section id="programmes" class="py-16 sm:py-20 md:py-24 bg-slate-800">
  <div class="container mx-auto px-4 sm:px-6">
    <div class="text-center mb-10 sm:mb-16 reveal">
      <h3 class="text-primary font-bold mb-3 sm:mb-4 text-xs sm:text-sm uppercase tracking-wider">Nos offres</h3>
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6 text-white">Programmes de Formation</h2>
      <p class="text-base sm:text-xl text-gray-400 max-w-3xl mx-auto px-2">
        Des programmes adaptés à tous les niveaux pour un développement complet
      </p>
    </div>

    <!-- École de Football - bloc horizontal -->
    <div class="card-hover reveal-scale bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl sm:rounded-2xl border border-slate-700 overflow-hidden">
      <div class="flex flex-col md:flex-row md:items-center">
        <div class="md:w-1/3 p-6 sm:p-8 md:p-12 flex items-center justify-center bg-slate-800/50">
          <div class="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-primary/20 rounded-xl sm:rounded-2xl flex items-center justify-center">
            <span class="material-symbols-outlined text-4xl sm:text-5xl md:text-7xl text-primary">sports_soccer</span>
          </div>
        </div>
        <div class="md:w-2/3 p-6 sm:p-8 md:p-12">
          <h3 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4">École de Football</h3>
          <p class="text-gray-400 text-base sm:text-lg mb-6 sm:mb-8">Formation technique et tactique pour les 5 à 13 ans.</p>
          ...
          <a href="{{ route('public.inscription') }}" class="inline-block px-6 py-3 sm:px-8 sm:py-4 bg-primary rounded-full font-bold text-sm sm:text-base hover:bg-primary/90 transition-all text-white">
...
<!-- Actualités Section -->
<section id="actualites" class="py-16 sm:py-20 md:py-24 bg-slate-900">
  <div class="container mx-auto px-4 sm:px-6">
    <!-- Header -->
    <div class="text-center mb-10 sm:mb-16">
      <h3 class="text-primary font-bold mb-3 sm:mb-4 text-xs sm:text-sm uppercase tracking-wider">Les dernières nouvelles</h3>
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6 text-white">Actualités</h2>
      <p class="text-base sm:text-xl text-gray-400 max-w-3xl mx-auto px-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
      ...
      <!-- Article 1 -->
      <article class="card-hover bg-slate-800 rounded-xl sm:rounded-2xl overflow-hidden border border-slate-700 group">
    ...
    <div class="text-center mt-8 sm:mt-12">
      <button class="px-6 py-3 sm:px-8 sm:py-4 bg-primary rounded-full font-bold text-base sm:text-lg hover:bg-primary/90 transition-all glow-button">
...
<!-- CTA Banner -->
<section class="py-16 sm:py-20 md:py-24 bg-gradient-to-r from-primary to-secondary relative overflow-hidden">
  ...
  <div class="container mx-auto px-4 sm:px-6 text-center relative z-10">
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6">Prêt à commencer l'aventure ?</h2>
    <p class="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-10 font-light">Rejoignez l'Academy Charles Kaboré dès aujourd'hui</p>
    <a href="{{ route('public.inscription') }}" class="inline-block px-8 py-4 sm:px-12 sm:py-5 bg-white text-primary rounded-full font-bold text-base sm:text-lg hover:bg-gray-100 transition-all glow-button">
